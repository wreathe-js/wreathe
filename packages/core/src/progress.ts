...
function addEventListeners(delay: number): void {
  document.addEventListener('wreathe:start', start.bind(null, delay))
  document.addEventListener('wreathe:progress', progress)
  document.addEventListener('wreathe:finish', finish)
}
