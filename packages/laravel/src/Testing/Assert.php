...
class Assert implements Arrayable
{
    ...
    {
        echo "\033[0;31mWreathe's built-in 'Assert' library will be removed in a future version of wreathe-laravel:\033[0m\n";
        echo "\033[0;31m - If you are seeing this error while using \$response->assertWreathe(...), please upgrade to Laravel 8.32.0 or higher.\033[0m\n";
        echo "\033[0;31m - If you are using the 'Assert' class directly, please adapt your tests to use the 'AssertableWreathe' class instead.\033[0m\n";
        echo "\033[0;31mFor more information and questions, please see https://github.com/inertiajs/inertia-laravel/pull/338 \033[0m\n\n";
        @trigger_error("Wreathe's built-in 'Assert' library will be removed in a future version of wreathe-laravel: https://github.com/inertiajs/inertia-laravel/pull/338", \E_USER_DEPRECATED);
    ...
    protected function scope(string $key, Closure $callback): self
    {
        ...
        PHPUnit::assertIsArray($props, sprintf('Wreathe property [%s] is not scopeable.', $path));
