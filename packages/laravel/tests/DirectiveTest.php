...
use Wreathe\Directive;
use Wreathe\Ssr\Gateway;
use Wreathe\Tests\Stubs\FakeGateway;
use Mockery as m;
...
class DirectiveTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->compiler->directive('wreathe', [Directive::class, 'compile']);
        $this->compiler->directive('wreatheHead', [Directive::class, 'compileHead']);
    }
    ...
    protected function renderView($contents, $data = [])
    {
        ...
        $path = tempnam(sys_get_temp_dir(), 'wreathe_tests_render_');
    ...
    public function test_wreathe_directive_renders_the_root_element(): void
    {
        $html = '<div id="app" data-page="{&quot;component&quot;:&quot;Foo\/Bar&quot;,&quot;props&quot;:{&quot;foo&quot;:&quot;bar&quot;},&quot;url&quot;:&quot;\/test&quot;,&quot;version&quot;:&quot;&quot;}"></div>';

        $this->assertSame($html, $this->renderView('@wreathe', ['page' => self::EXAMPLE_PAGE_OBJECT]));
        $this->assertSame($html, $this->renderView('@wreathe()', ['page' => self::EXAMPLE_PAGE_OBJECT]));
        $this->assertSame($html, $this->renderView('@wreathe("")', ['page' => self::EXAMPLE_PAGE_OBJECT]));
        $this->assertSame($html, $this->renderView("@wreathe('')", ['page' => self::EXAMPLE_PAGE_OBJECT]));
    }

    public function test_wreathe_directive_renders_server_side_rendered_content_when_enabled(): void
    {
        Config::set(['wreathe.ssr.enabled' => true]);

        $this->assertSame(
            '<p>This is some example SSR content</p>',
            $this->renderView('@wreathe', ['page' => self::EXAMPLE_PAGE_OBJECT])
        );
    }

    public function test_wreathe_directive_can_use_a_different_root_element_id(): void
    {
        $html = '<div id="foo" data-page="{&quot;component&quot;:&quot;Foo\/Bar&quot;,&quot;props&quot;:{&quot;foo&quot;:&quot;bar&quot;},&quot;url&quot;:&quot;\/test&quot;,&quot;version&quot;:&quot;&quot;}"></div>';

        $this->assertSame($html, $this->renderView('@wreathe(foo)', ['page' => self::EXAMPLE_PAGE_OBJECT]));
        $this->assertSame($html, $this->renderView("@wreathe('foo')", ['page' => self::EXAMPLE_PAGE_OBJECT]));
        $this->assertSame($html, $this->renderView('@wreathe("foo")', ['page' => self::EXAMPLE_PAGE_OBJECT]));
    }

    public function test_wreathe_head_directive_renders_nothing(): void
    {
        $this->assertEmpty($this->renderView('@wreatheHead', ['page' => self::EXAMPLE_PAGE_OBJECT]));
    }

    public function test_wreathe_head_directive_renders_server_side_rendered_head_elements_when_enabled(): void
    {
        Config::set(['wreathe.ssr.enabled' => true]);

        $this->assertSame(
            "<meta charset=\"UTF-8\" />\n<title wreathe>Example SSR Title</title>\n",
            $this->renderView('@wreatheHead', ['page' => self::EXAMPLE_PAGE_OBJECT])
        );
    }
