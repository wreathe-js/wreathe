...
use Wreathe\Tests\Stubs\FakeResource;
use Mockery;
...
class ResponseTest extends TestCase
{
    ...
    public function test_xhr_partial_response(): void
    {
        $request = Request::create('/user/123', 'GET');
        $request->headers->add(['X-Wreathe' => 'true']);
        $request->headers->add(['X-Wreathe-Partial-Component' => 'User/Edit']);
        $request->headers->add(['X-Wreathe-Partial-Data' => 'partial']);
    ...
    public function test_lazy_props_are_included_in_partial_reload(): void
    {
        $request = Request::create('/users', 'GET');
        $request->headers->add(['X-Wreathe' => 'true']);
        $request->headers->add(['X-Wreathe-Partial-Component' => 'Users']);
        $request->headers->add(['X-Wreathe-Partial-Data' => 'lazy']);
